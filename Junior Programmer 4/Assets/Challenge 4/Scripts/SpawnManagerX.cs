...
public class SpawnManagerX : MonoBehaviour
{
    ...
    private float enemySpeedMultiplier = 1f; // ตัวคูณความเร็วศัตรู
    ...
    void SpawnEnemyWave(int enemiesToSpawn)
    {
        ...
        for (int i = 0; i < enemiesToSpawn; i++)
        {
            ...
            // เข้าถึง EnemyX script แล้วเพิ่มความเร็ว
            EnemyX enemyScript = enemy.GetComponent<EnemyX>();
            if (enemyScript != null)
            {
                // คูณ speed ของศัตรูด้วยตัวคูณ
                enemyScript.speed *= enemySpeedMultiplier;
            }
        }

        // เพิ่มตัวคูณความเร็วทุกครั้งที่เรียกฟังก์ชัน
